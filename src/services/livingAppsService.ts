...
import type { Artikel, Kategorien, Verkaeufer, CreateArtikel, CreateKategorien, CreateVerkaeufer } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async createArtikelEntry(fields: CreateArtikel) {
    return callApi('POST', `/apps/${APP_IDS.ARTIKEL}/records`, { fields: cleanFieldsForApi(fields as any, 'artikel') });
  }
  static async updateArtikelEntry(id: string, fields: Partial<CreateArtikel>) {
    return callApi('PATCH', `/apps/${APP_IDS.ARTIKEL}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'artikel') });
  }
  ...
  static async createVerkaeuferEntry(fields: CreateVerkaeufer) {
    return callApi('POST', `/apps/${APP_IDS.VERKAEUFER}/records`, { fields: cleanFieldsForApi(fields as any, 'verkaeufer') });
  }
  static async updateVerkaeuferEntry(id: string, fields: Partial<CreateVerkaeufer>) {
    return callApi('PATCH', `/apps/${APP_IDS.VERKAEUFER}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'verkaeufer') });
  }
